    ...
    <div class="navbar navbar-wp navbar-arrow mega-nav" role="navigation">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href='<c:url value="/login"/>' class="dropdown-toggle" data-toggle="dropdown"><strong><fmt:message key="MEMBER"/></strong></a>
                    <ul class="dropdown-menu">
                    	<li><a href="<c:url value='/login'/>"><fmt:message key="MY_INFO"/></a>
                        <li><a href="<c:url value='/logout'/>"><fmt:message key="SIGN_OUT"/></a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-user">
                        <li id="dropdownForm">
                            <div class="dropdown-form">
                                <form class="form-horizontal form-light p-15" action="<c:url value='/search'/>" method="post" role="form">
